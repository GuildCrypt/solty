...
var SoltyUint240 = /** @class */ (function (_super) {
    __extends(SoltyUint240, _super);
    function SoltyUint240(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 30;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Uint240', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyUint240.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyUint240.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyUint240.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyUint240.prototype.getNumber = function () {
        if (this.number) {
            return this.number;
        }
    ...
    SoltyUint240.prototype.getBignumber = function (Bignumber) {
        return new Bignumber(this.getHexp());
    };
    SoltyUint240.prototype.getBn = function (Bn) {
        return new Bn(this.getHexu(), 16);
    };
    SoltyUint240.bytesLength = 30;
    return SoltyUint240;
}(Solty_1.Solty));
exports.SoltyUint240 = SoltyUint240;
