...
var SoltyUint136 = /** @class */ (function (_super) {
    __extends(SoltyUint136, _super);
    function SoltyUint136(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 17;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Uint136', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyUint136.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyUint136.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyUint136.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyUint136.prototype.getNumber = function () {
        if (this.number) {
            return this.number;
        }
    ...
    SoltyUint136.prototype.getBignumber = function (Bignumber) {
        return new Bignumber(this.getHexp());
    };
    SoltyUint136.prototype.getBn = function (Bn) {
        return new Bn(this.getHexu(), 16);
    };
    SoltyUint136.bytesLength = 17;
    return SoltyUint136;
}(Solty_1.Solty));
exports.SoltyUint136 = SoltyUint136;
