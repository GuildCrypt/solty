...
var SoltyUint208 = /** @class */ (function (_super) {
    __extends(SoltyUint208, _super);
    function SoltyUint208(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 26;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Uint208', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyUint208.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyUint208.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyUint208.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyUint208.prototype.getNumber = function () {
        if (this.number) {
            return this.number;
        }
    ...
    SoltyUint208.prototype.getBignumber = function (Bignumber) {
        return new Bignumber(this.getHexp());
    };
    SoltyUint208.prototype.getBn = function (Bn) {
        return new Bn(this.getHexu(), 16);
    };
    SoltyUint208.bytesLength = 26;
    return SoltyUint208;
}(Solty_1.Solty));
exports.SoltyUint208 = SoltyUint208;
