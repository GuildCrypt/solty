...
var SoltyUint144 = /** @class */ (function (_super) {
    __extends(SoltyUint144, _super);
    function SoltyUint144(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 18;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Uint144', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyUint144.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyUint144.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyUint144.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyUint144.prototype.getNumber = function () {
        if (this.number) {
            return this.number;
        }
    ...
    SoltyUint144.prototype.getBignumber = function (Bignumber) {
        return new Bignumber(this.getHexp());
    };
    SoltyUint144.prototype.getBn = function (Bn) {
        return new Bn(this.getHexu(), 16);
    };
    SoltyUint144.bytesLength = 18;
    return SoltyUint144;
}(Solty_1.Solty));
exports.SoltyUint144 = SoltyUint144;
