...
var SoltyUint96 = /** @class */ (function (_super) {
    __extends(SoltyUint96, _super);
    function SoltyUint96(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 12;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Uint96', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyUint96.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyUint96.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyUint96.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyUint96.prototype.getNumber = function () {
        if (this.number) {
            return this.number;
        }
    ...
    SoltyUint96.prototype.getBignumber = function (Bignumber) {
        return new Bignumber(this.getHexp());
    };
    SoltyUint96.prototype.getBn = function (Bn) {
        return new Bn(this.getHexu(), 16);
    };
    SoltyUint96.bytesLength = 12;
    return SoltyUint96;
}(Solty_1.Solty));
exports.SoltyUint96 = SoltyUint96;
