...
var SoltyUint56 = /** @class */ (function (_super) {
    __extends(SoltyUint56, _super);
    function SoltyUint56(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 7;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Uint56', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyUint56.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyUint56.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyUint56.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyUint56.prototype.getNumber = function () {
        if (this.number) {
            return this.number;
        }
    ...
    SoltyUint56.prototype.getBignumber = function (Bignumber) {
        return new Bignumber(this.getHexp());
    };
    SoltyUint56.prototype.getBn = function (Bn) {
        return new Bn(this.getHexu(), 16);
    };
    SoltyUint56.bytesLength = 7;
    return SoltyUint56;
}(Solty_1.Solty));
exports.SoltyUint56 = SoltyUint56;
