...
var SoltyUint8 = /** @class */ (function (_super) {
    __extends(SoltyUint8, _super);
    function SoltyUint8(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 1;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Uint8', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyUint8.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyUint8.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyUint8.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyUint8.prototype.getNumber = function () {
        if (this.number) {
            return this.number;
        }
    ...
    SoltyUint8.prototype.getBignumber = function (Bignumber) {
        return new Bignumber(this.getHexp());
    };
    SoltyUint8.prototype.getBn = function (Bn) {
        return new Bn(this.getHexu(), 16);
    };
    SoltyUint8.bytesLength = 1;
    return SoltyUint8;
}(Solty_1.Solty));
exports.SoltyUint8 = SoltyUint8;
