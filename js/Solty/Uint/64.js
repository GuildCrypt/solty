...
var SoltyUint64 = /** @class */ (function (_super) {
    __extends(SoltyUint64, _super);
    function SoltyUint64(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 8;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Uint64', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyUint64.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyUint64.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyUint64.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyUint64.prototype.getNumber = function () {
        if (this.number) {
            return this.number;
        }
    ...
    SoltyUint64.prototype.getBignumber = function (Bignumber) {
        return new Bignumber(this.getHexp());
    };
    SoltyUint64.prototype.getBn = function (Bn) {
        return new Bn(this.getHexu(), 16);
    };
    SoltyUint64.bytesLength = 8;
    return SoltyUint64;
}(Solty_1.Solty));
exports.SoltyUint64 = SoltyUint64;
