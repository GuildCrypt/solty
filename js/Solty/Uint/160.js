...
var SoltyUint160 = /** @class */ (function (_super) {
    __extends(SoltyUint160, _super);
    function SoltyUint160(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 20;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Uint160', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyUint160.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyUint160.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyUint160.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyUint160.prototype.getNumber = function () {
        if (this.number) {
            return this.number;
        }
    ...
    SoltyUint160.prototype.getBignumber = function (Bignumber) {
        return new Bignumber(this.getHexp());
    };
    SoltyUint160.prototype.getBn = function (Bn) {
        return new Bn(this.getHexu(), 16);
    };
    SoltyUint160.bytesLength = 20;
    return SoltyUint160;
}(Solty_1.Solty));
exports.SoltyUint160 = SoltyUint160;
