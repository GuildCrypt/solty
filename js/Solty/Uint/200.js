...
var SoltyUint200 = /** @class */ (function (_super) {
    __extends(SoltyUint200, _super);
    function SoltyUint200(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 25;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Uint200', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyUint200.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyUint200.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyUint200.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyUint200.prototype.getNumber = function () {
        if (this.number) {
            return this.number;
        }
    ...
    SoltyUint200.prototype.getBignumber = function (Bignumber) {
        return new Bignumber(this.getHexp());
    };
    SoltyUint200.prototype.getBn = function (Bn) {
        return new Bn(this.getHexu(), 16);
    };
    SoltyUint200.bytesLength = 25;
    return SoltyUint200;
}(Solty_1.Solty));
exports.SoltyUint200 = SoltyUint200;
