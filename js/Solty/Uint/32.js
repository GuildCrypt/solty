...
var SoltyUint32 = /** @class */ (function (_super) {
    __extends(SoltyUint32, _super);
    function SoltyUint32(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 4;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Uint32', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyUint32.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyUint32.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyUint32.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyUint32.prototype.getNumber = function () {
        if (this.number) {
            return this.number;
        }
    ...
    SoltyUint32.prototype.getBignumber = function (Bignumber) {
        return new Bignumber(this.getHexp());
    };
    SoltyUint32.prototype.getBn = function (Bn) {
        return new Bn(this.getHexu(), 16);
    };
    SoltyUint32.bytesLength = 4;
    return SoltyUint32;
}(Solty_1.Solty));
exports.SoltyUint32 = SoltyUint32;
