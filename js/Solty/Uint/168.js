...
var SoltyUint168 = /** @class */ (function (_super) {
    __extends(SoltyUint168, _super);
    function SoltyUint168(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 21;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Uint168', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyUint168.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyUint168.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyUint168.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyUint168.prototype.getNumber = function () {
        if (this.number) {
            return this.number;
        }
    ...
    SoltyUint168.prototype.getBignumber = function (Bignumber) {
        return new Bignumber(this.getHexp());
    };
    SoltyUint168.prototype.getBn = function (Bn) {
        return new Bn(this.getHexu(), 16);
    };
    SoltyUint168.bytesLength = 21;
    return SoltyUint168;
}(Solty_1.Solty));
exports.SoltyUint168 = SoltyUint168;
