...
var SoltyUint88 = /** @class */ (function (_super) {
    __extends(SoltyUint88, _super);
    function SoltyUint88(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 11;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Uint88', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyUint88.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyUint88.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyUint88.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyUint88.prototype.getNumber = function () {
        if (this.number) {
            return this.number;
        }
    ...
    SoltyUint88.prototype.getBignumber = function (Bignumber) {
        return new Bignumber(this.getHexp());
    };
    SoltyUint88.prototype.getBn = function (Bn) {
        return new Bn(this.getHexu(), 16);
    };
    SoltyUint88.bytesLength = 11;
    return SoltyUint88;
}(Solty_1.Solty));
exports.SoltyUint88 = SoltyUint88;
