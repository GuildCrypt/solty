...
var SoltyUint232 = /** @class */ (function (_super) {
    __extends(SoltyUint232, _super);
    function SoltyUint232(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 29;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Uint232', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyUint232.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyUint232.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyUint232.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyUint232.prototype.getNumber = function () {
        if (this.number) {
            return this.number;
        }
    ...
    SoltyUint232.prototype.getBignumber = function (Bignumber) {
        return new Bignumber(this.getHexp());
    };
    SoltyUint232.prototype.getBn = function (Bn) {
        return new Bn(this.getHexu(), 16);
    };
    SoltyUint232.bytesLength = 29;
    return SoltyUint232;
}(Solty_1.Solty));
exports.SoltyUint232 = SoltyUint232;
