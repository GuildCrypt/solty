...
var SoltyUint184 = /** @class */ (function (_super) {
    __extends(SoltyUint184, _super);
    function SoltyUint184(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 23;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Uint184', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyUint184.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyUint184.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyUint184.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyUint184.prototype.getNumber = function () {
        if (this.number) {
            return this.number;
        }
    ...
    SoltyUint184.prototype.getBignumber = function (Bignumber) {
        return new Bignumber(this.getHexp());
    };
    SoltyUint184.prototype.getBn = function (Bn) {
        return new Bn(this.getHexu(), 16);
    };
    SoltyUint184.bytesLength = 23;
    return SoltyUint184;
}(Solty_1.Solty));
exports.SoltyUint184 = SoltyUint184;
