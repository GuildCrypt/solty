...
var SoltyUint152 = /** @class */ (function (_super) {
    __extends(SoltyUint152, _super);
    function SoltyUint152(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 19;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Uint152', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyUint152.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyUint152.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyUint152.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyUint152.prototype.getNumber = function () {
        if (this.number) {
            return this.number;
        }
    ...
    SoltyUint152.prototype.getBignumber = function (Bignumber) {
        return new Bignumber(this.getHexp());
    };
    SoltyUint152.prototype.getBn = function (Bn) {
        return new Bn(this.getHexu(), 16);
    };
    SoltyUint152.bytesLength = 19;
    return SoltyUint152;
}(Solty_1.Solty));
exports.SoltyUint152 = SoltyUint152;
