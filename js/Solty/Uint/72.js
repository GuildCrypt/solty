...
var SoltyUint72 = /** @class */ (function (_super) {
    __extends(SoltyUint72, _super);
    function SoltyUint72(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 9;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Uint72', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyUint72.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyUint72.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyUint72.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyUint72.prototype.getNumber = function () {
        if (this.number) {
            return this.number;
        }
    ...
    SoltyUint72.prototype.getBignumber = function (Bignumber) {
        return new Bignumber(this.getHexp());
    };
    SoltyUint72.prototype.getBn = function (Bn) {
        return new Bn(this.getHexu(), 16);
    };
    SoltyUint72.bytesLength = 9;
    return SoltyUint72;
}(Solty_1.Solty));
exports.SoltyUint72 = SoltyUint72;
