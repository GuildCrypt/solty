...
var SoltyBytes4 = /** @class */ (function (_super) {
    __extends(SoltyBytes4, _super);
    function SoltyBytes4(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 4;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Bytes4', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyBytes4.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyBytes4.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyBytes4.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyBytes4.bytesLength = 4;
    return SoltyBytes4;
}(Solty_1.Solty));
exports.SoltyBytes4 = SoltyBytes4;
