...
var SoltyBytes20 = /** @class */ (function (_super) {
    __extends(SoltyBytes20, _super);
    function SoltyBytes20(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 20;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Bytes20', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyBytes20.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyBytes20.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyBytes20.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyBytes20.bytesLength = 20;
    return SoltyBytes20;
}(Solty_1.Solty));
exports.SoltyBytes20 = SoltyBytes20;
