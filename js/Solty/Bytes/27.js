...
var SoltyBytes27 = /** @class */ (function (_super) {
    __extends(SoltyBytes27, _super);
    function SoltyBytes27(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 27;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Bytes27', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyBytes27.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyBytes27.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyBytes27.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyBytes27.bytesLength = 27;
    return SoltyBytes27;
}(Solty_1.Solty));
exports.SoltyBytes27 = SoltyBytes27;
