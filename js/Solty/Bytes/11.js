...
var SoltyBytes11 = /** @class */ (function (_super) {
    __extends(SoltyBytes11, _super);
    function SoltyBytes11(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 11;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Bytes11', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyBytes11.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyBytes11.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyBytes11.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyBytes11.bytesLength = 11;
    return SoltyBytes11;
}(Solty_1.Solty));
exports.SoltyBytes11 = SoltyBytes11;
