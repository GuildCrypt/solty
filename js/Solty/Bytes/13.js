...
var SoltyBytes13 = /** @class */ (function (_super) {
    __extends(SoltyBytes13, _super);
    function SoltyBytes13(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 13;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Bytes13', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyBytes13.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyBytes13.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyBytes13.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyBytes13.bytesLength = 13;
    return SoltyBytes13;
}(Solty_1.Solty));
exports.SoltyBytes13 = SoltyBytes13;
