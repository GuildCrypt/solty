...
var SoltyBytes31 = /** @class */ (function (_super) {
    __extends(SoltyBytes31, _super);
    function SoltyBytes31(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 31;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Bytes31', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyBytes31.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyBytes31.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyBytes31.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyBytes31.bytesLength = 31;
    return SoltyBytes31;
}(Solty_1.Solty));
exports.SoltyBytes31 = SoltyBytes31;
