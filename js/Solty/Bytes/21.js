...
var SoltyBytes21 = /** @class */ (function (_super) {
    __extends(SoltyBytes21, _super);
    function SoltyBytes21(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 21;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Bytes21', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyBytes21.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyBytes21.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyBytes21.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyBytes21.bytesLength = 21;
    return SoltyBytes21;
}(Solty_1.Solty));
exports.SoltyBytes21 = SoltyBytes21;
