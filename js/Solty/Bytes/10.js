...
var SoltyBytes10 = /** @class */ (function (_super) {
    __extends(SoltyBytes10, _super);
    function SoltyBytes10(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 10;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Bytes10', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyBytes10.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyBytes10.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyBytes10.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyBytes10.bytesLength = 10;
    return SoltyBytes10;
}(Solty_1.Solty));
exports.SoltyBytes10 = SoltyBytes10;
