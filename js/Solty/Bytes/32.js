...
var SoltyBytes32 = /** @class */ (function (_super) {
    __extends(SoltyBytes32, _super);
    function SoltyBytes32(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 32;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Bytes32', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyBytes32.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyBytes32.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyBytes32.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyBytes32.bytesLength = 32;
    return SoltyBytes32;
}(Solty_1.Solty));
exports.SoltyBytes32 = SoltyBytes32;
