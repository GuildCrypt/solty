...
var SoltyBytes17 = /** @class */ (function (_super) {
    __extends(SoltyBytes17, _super);
    function SoltyBytes17(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 17;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Bytes17', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyBytes17.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyBytes17.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyBytes17.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyBytes17.bytesLength = 17;
    return SoltyBytes17;
}(Solty_1.Solty));
exports.SoltyBytes17 = SoltyBytes17;
