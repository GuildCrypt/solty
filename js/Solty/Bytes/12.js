...
var SoltyBytes12 = /** @class */ (function (_super) {
    __extends(SoltyBytes12, _super);
    function SoltyBytes12(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 12;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Bytes12', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyBytes12.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyBytes12.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyBytes12.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyBytes12.bytesLength = 12;
    return SoltyBytes12;
}(Solty_1.Solty));
exports.SoltyBytes12 = SoltyBytes12;
