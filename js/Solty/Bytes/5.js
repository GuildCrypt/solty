...
var SoltyBytes5 = /** @class */ (function (_super) {
    __extends(SoltyBytes5, _super);
    function SoltyBytes5(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 5;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Bytes5', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyBytes5.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyBytes5.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyBytes5.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyBytes5.bytesLength = 5;
    return SoltyBytes5;
}(Solty_1.Solty));
exports.SoltyBytes5 = SoltyBytes5;
