...
var SoltyBytes18 = /** @class */ (function (_super) {
    __extends(SoltyBytes18, _super);
    function SoltyBytes18(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 18;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Bytes18', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyBytes18.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyBytes18.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyBytes18.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyBytes18.bytesLength = 18;
    return SoltyBytes18;
}(Solty_1.Solty));
exports.SoltyBytes18 = SoltyBytes18;
