...
var SoltyBytes28 = /** @class */ (function (_super) {
    __extends(SoltyBytes28, _super);
    function SoltyBytes28(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 28;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Bytes28', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyBytes28.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyBytes28.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyBytes28.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyBytes28.bytesLength = 28;
    return SoltyBytes28;
}(Solty_1.Solty));
exports.SoltyBytes28 = SoltyBytes28;
