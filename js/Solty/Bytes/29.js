...
var SoltyBytes29 = /** @class */ (function (_super) {
    __extends(SoltyBytes29, _super);
    function SoltyBytes29(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 29;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Bytes29', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyBytes29.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyBytes29.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyBytes29.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyBytes29.bytesLength = 29;
    return SoltyBytes29;
}(Solty_1.Solty));
exports.SoltyBytes29 = SoltyBytes29;
