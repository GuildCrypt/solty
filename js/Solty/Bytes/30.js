...
var SoltyBytes30 = /** @class */ (function (_super) {
    __extends(SoltyBytes30, _super);
    function SoltyBytes30(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 30;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Bytes30', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyBytes30.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyBytes30.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyBytes30.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyBytes30.bytesLength = 30;
    return SoltyBytes30;
}(Solty_1.Solty));
exports.SoltyBytes30 = SoltyBytes30;
