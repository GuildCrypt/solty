...
var SoltyBytes6 = /** @class */ (function (_super) {
    __extends(SoltyBytes6, _super);
    function SoltyBytes6(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 6;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Bytes6', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyBytes6.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyBytes6.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyBytes6.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyBytes6.bytesLength = 6;
    return SoltyBytes6;
}(Solty_1.Solty));
exports.SoltyBytes6 = SoltyBytes6;
