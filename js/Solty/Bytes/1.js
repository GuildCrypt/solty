...
var SoltyBytes1 = /** @class */ (function (_super) {
    __extends(SoltyBytes1, _super);
    function SoltyBytes1(bytes) {
        var _this = _super.call(this, bytes) || this;
        _this.bytesLength = 1;
        if (bytes.length !== _this.bytesLength) {
            throw new InvalidBytesLengthError_1.InvalidBytesLengthError('Bytes1', _this.bytesLength, bytes.length);
        }
        return _this;
    }
    SoltyBytes1.getRandom = function (hexu) {
        return new this(getRandomUint8Array_1.getRandomUint8Array(this.bytesLength));
    };
    SoltyBytes1.fromHexu = function (hexu) {
        return new this(convertHexuToUint8Array_1.convertHexuToUint8Array(hexu));
    };
    SoltyBytes1.fromHexp = function (hexp) {
        return this.fromHexu(convertHexpToHexu_1.convertHexpToHexu(hexp));
    };
    SoltyBytes1.bytesLength = 1;
    return SoltyBytes1;
}(Solty_1.Solty));
exports.SoltyBytes1 = SoltyBytes1;
