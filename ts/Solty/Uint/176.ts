...
export class SoltyUint176 extends Solty {
  ...
  constructor(bytes: Uint8Array) {
    ...
    if (bytes.length !== this.bytesLength) {
      throw new InvalidBytesLengthError('Uint176', this.bytesLength, bytes.length)
    }
  }

  static getRandom(hexu: string): SoltyUint176 {
    return new this(getRandomUint8Array(this.bytesLength))
  }
  static fromHexu(hexu: string): SoltyUint176 {
    return new this(convertHexuToUint8Array(hexu))
  }
  static fromHexp(hexp: string): SoltyUint176 {
