...
export class SoltyUint120 extends Solty {
  ...
  constructor(bytes: Uint8Array) {
    ...
    if (bytes.length !== this.bytesLength) {
      throw new InvalidBytesLengthError('Uint120', this.bytesLength, bytes.length)
    }
  }

  static getRandom(hexu: string): SoltyUint120 {
    return new this(getRandomUint8Array(this.bytesLength))
  }
  static fromHexu(hexu: string): SoltyUint120 {
    return new this(convertHexuToUint8Array(hexu))
  }
  static fromHexp(hexp: string): SoltyUint120 {
