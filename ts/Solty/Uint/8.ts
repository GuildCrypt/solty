...
export class SoltyUint8 extends Solty {
  ...
  constructor(bytes: Uint8Array) {
    ...
    if (bytes.length !== this.bytesLength) {
      throw new InvalidBytesLengthError('Uint8', this.bytesLength, bytes.length)
    }
  }

  static getRandom(hexu: string): SoltyUint8 {
    return new this(getRandomUint8Array(this.bytesLength))
  }
  static fromHexu(hexu: string): SoltyUint8 {
    return new this(convertHexuToUint8Array(hexu))
  }
  static fromHexp(hexp: string): SoltyUint8 {
