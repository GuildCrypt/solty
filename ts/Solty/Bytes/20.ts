...
export class SoltyBytes20 extends Solty {
  ...
  constructor(bytes: Uint8Array) {
    ...
    if (bytes.length !== this.bytesLength) {
      throw new InvalidBytesLengthError('Bytes20', this.bytesLength, bytes.length)
    }
  }

  static getRandom(hexu: string): SoltyBytes20 {
    return new this(getRandomUint8Array(this.bytesLength))
  }
  static fromHexu(hexu: string): SoltyBytes20 {
    return new this(convertHexuToUint8Array(hexu))
  }
  static fromHexp(hexp: string): SoltyBytes20 {
