...
export class SoltyBytes14 extends Solty {
  ...
  constructor(bytes: Uint8Array) {
    ...
    if (bytes.length !== this.bytesLength) {
      throw new InvalidBytesLengthError('Bytes14', this.bytesLength, bytes.length)
    }
  }

  static getRandom(hexu: string): SoltyBytes14 {
    return new this(getRandomUint8Array(this.bytesLength))
  }
  static fromHexu(hexu: string): SoltyBytes14 {
    return new this(convertHexuToUint8Array(hexu))
  }
  static fromHexp(hexp: string): SoltyBytes14 {
